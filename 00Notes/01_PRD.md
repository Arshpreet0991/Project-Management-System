...
- `PRD` is the first step we take before building a project.
- We decide on what `kind of data` we will be storing in our backend.
- We decide on which features to include and which features to exclude.
- `Example:` An auth system
  - `Includes:`
    - create an account
    - login a user
...
# PRD for our Project Management System
